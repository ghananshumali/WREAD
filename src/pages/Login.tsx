  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-foreground flex-col justify-between p-12">
        ...
        />
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-primary/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4" />
        <div className="absolute top-0 right-0 w-56 h-56 bg-primary/10 rounded-full blur-2xl -translate-y-1/4 translate-x-1/4" />
        ...
        <div className="relative z-10 space-y-4">
          <blockquote className="font-display text-3xl font-bold italic text-background leading-snug">
            "Read deeply.<br />Write freely."
          </blockquote>
          <p className="text-background/50 text-sm">A calm space for thoughtful ideas.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm space-y-8 animate-slide-up">
          ...
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-sm">Sign in to continue reading</p>
          </div>
